...
double dotproduct(const double a1[], const double a2[], int size); // by reference by default, size es el tamano de los arreglos
...
int main(int argc, char **argv)
{
    ...
    init(v1, v2, N); //Sobre escribo los valores nuevos sobre la declaracion anterior
